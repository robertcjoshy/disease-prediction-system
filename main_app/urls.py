...
urlpatterns = [
    ...
    path('dviewprofiles/<str:doctorusername>', views.dviewprofiles , name='dviewprofiles'),
    path('dviewprofiless/<str:doctorusername>', views.dviewprofiless , name='dviewprofiless'),
    ...
    path('close_doctor_consultation/<int:consultation_id>', views.close_doctor_consultation , name='close_doctor_consultation'),
